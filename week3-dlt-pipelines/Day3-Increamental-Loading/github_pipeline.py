...
def load_duckdb_repo_reactions_issues_only() -> None:
    ...
    pipeline = dlt.pipeline(
        "github_reactions_increamental",
        destination='snowflake',
        dataset_name="duckdb_issues_increment",
        # dev_mode=True,
    )
...
def load_duckdb_repo_pull_requests_only() -> None:
    """Loads pull requests, their comments and reactions for duckdb"""
    pipeline = dlt.pipeline(
        "github_reactions",
        destination='snowflake',
